...
abstract public class BaseAdapter<E extends BaseEnty, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public int getItemViewType(int position) {
        ...
        } else if (multyItem && position > mHeaderViews.size() && position <= mHeaderViews.size() + mDataList.size()) {
    ...
    public void onBindViewHolder(@NonNull BaseViewHolder viewHolder, int position) {
        ...
        if (mHeaderViews.get(viewType) != null) {
            ...
            onItemClickListener.onItemClick(viewHolder.itemView, position - mHeaderViews.size());
        }
    }
